...
<template>
  <DeckSlide section-label="ハンズオン" eyebrow="HANDS ON" footer-label="WORKSHOP">
    <div class="deck-centered">
      <p class="deck-step-title deck-step-title--hands-on">作業フォルダに移動する</p>
      <CommandBlock command="cd first-repo" variant="hands-on" />
      <p class="deck-note">このフォルダの中でGit操作を進める</p>
    </div>
