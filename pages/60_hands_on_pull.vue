...
<template>
  <DeckSlide section-label="ハンズオン" eyebrow="HANDS ON" footer-label="WORKSHOP">
    <div class="deck-centered">
      <p class="deck-step-title deck-step-title--hands-on">GitHubの最新状態を手元に取り込む</p>
      <CommandBlock command="git pull" variant="hands-on" />
      <p class="deck-note">リモートでマージされた変更をローカルへ反映する</p>
    </div>
