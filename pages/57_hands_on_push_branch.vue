...
<template>
  <DeckSlide section-label="ハンズオン" eyebrow="HANDS ON" footer-label="WORKSHOP">
    <div class="deck-centered">
      <p class="deck-step-title deck-step-title--hands-on">ブランチをGitHubへアップロードする</p>
      <CommandBlock command="git push -u origin feat/first-pr" variant="hands-on" />
      <p class="deck-note">Pull Request用のブランチをリモートに置く</p>
    </div>
